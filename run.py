...
def parse_args():
    ...
    parser.add_argument('--node_pert_var_noise_z', type=float, default=1e-4, help='unscaled variance of entries in z(final layer) input node pertubation')

    parser.add_argument('--np_delay_feedback', action= 'store_true')
